...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/issue-type'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IssueType) {
        return item.id;
    }
