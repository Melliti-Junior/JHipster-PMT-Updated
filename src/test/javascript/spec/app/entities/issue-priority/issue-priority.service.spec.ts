...
describe('Service Tests', () => {
    ...
    describe('IssuePriority Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(IssuePriorityService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/issue-priorities';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + '123');
            });
            it('should return IssuePriority', () => {

                let entity: IssuePriority;
                service.find('123').subscribe((_entity: IssuePriority) => {
                    entity = _entity;
                });
