...
import { ColumnDialogComponent } from '../../../../../../main/webapp/app/entities/column/column-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Column Management Dialog Component', () => {
        let comp: ColumnDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ColumnDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'columnListModification', content: 'OK'});
